...
//		//coffee should be 2.0 + 0 + 0
//		System.out.println("Regular Coffee Price: " + orderOne.getBeverage(0).calcPrice());
//		
//		// mohito should be regular base price, 2.0
//		System.out.println("Mohito Price: " + orderOne.getBeverage(1).calcPrice());
//		
//		// detox price should be 2.0 + 0.5 for medium upsize + 0.5 fruit charge + 0.0 for protein powder
//		System.out.println("Detox Price: " + orderOne.getBeverage(2).calcPrice());
//		
//		System.out.println("Number of fruits: " + orderOne.getBeverage(2));
//		
//		System.out.println("Order Total: " + orderOne.calcOrderTotal());
//		
